...
void add_default_options(po::options_description &desc) {
  desc.add_options()("help,h", "produce help message")(
      ...
      "kernel1", po::value<std::string>()->required(),
      ...
      "M1", po::value<int>()->default_value(512), "FFN-1 size M")(
      "K1", po::value<int>()->default_value(512), "FFN-1 size K")(
      "N1", po::value<int>()->default_value(512), "FFN-1 Matrix size N")(
      "M2", po::value<int>()->default_value(512), "FFN-2 size M")(
      "K2", po::value<int>()->default_value(512), "FFN-2 size K")(
      "N2", po::value<int>()->default_value(512),
      "FFN-2 Matrix size N")("iters", po::value<int>()->default_value(1))(
