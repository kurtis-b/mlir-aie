...
def my_mha(
    ...
    def device_body():
        ...
        o2_l1l2_fifos = object_fifo(f"o2_L1L2", core_tiles[1][2], mem_tiles[2], fifo_depth, o2_l1_ty)
        o2_l2l3_fifos = object_fifo(f"o2_L2L3", mem_tiles[2], shim_tiles[2], fifo_depth, o2_l1_ty)
        object_fifo_link(o2_l1l2_fifos, o2_l2l3_fifos)
        ...
        def core_body():
            for _ in range_(0xFFFFFFFF):
                for _ in range_(H):
                    elem_o2 = o2_l1l2_fifos.acquire(ObjectFifoPort.Produce, 1)
                    ...
                    o2_l1l2_fifos.release(ObjectFifoPort.Produce, 1)
