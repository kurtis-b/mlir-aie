            ...
            for _ in range_(0xFFFFFFFF):
                for _ in range_(H):
                    ...
                    for _ in range_(head_dim // o3_matmul_dims[2]):
                        elem_o3 = o3_l1l2_fifos.acquire(ObjectFifoPort.Produce, 1)
                        zero_o3(elem_o3)
                        ...
                        o3_l1l2_fifos.release(ObjectFifoPort.Produce, 1)
                ...
                for head in range(H):
                    for row_offset in range(0, M, o1_matmul_dims[0][0]):
                        ...
                        npu_dma_memcpy_nd(
                            ...
                            sizes=[M // o3_matmul_dims[1], head_dim // o3_matmul_dims[2], o3_matmul_dims[1], o3_matmul_dims[2]],
                            strides=[o3_matmul_dims[1] * N, o3_matmul_dims[2], N, 1],
                        )

                        npu_dma_memcpy_nd(
                            metadata=o3_l2l3_fifos,
                            bd_id=3,
                            mem=C,
                            offsets=[0, 0, 0, 3 * M * N + row_offset * N + head * head_dim],
                            sizes=[1, head_dim // o3_matmul_dims[2], o3_matmul_dims[0], o3_matmul_dims[2]],
                            strides=[0, o3_matmul_dims[2], N, 1],
                        )

                        dma_wait(o3_l2l3_fifos)
